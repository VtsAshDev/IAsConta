 ...
 */
class getTelegramUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TelegramUserRepository' shared autowired service.
     *
     * @return \App\Repository\TelegramUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Interfaces'.\DIRECTORY_SEPARATOR.'TelegramUserRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TelegramUserRepository.php';

        return $container->privates['App\\Repository\\TelegramUserRepository'] = new \App\Repository\TelegramUserRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
